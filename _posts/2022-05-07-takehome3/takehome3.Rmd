...
* Interactive graphs are generally more engaging and provide more options for viewing, thus are likely to generate more insights than static graphs. * However, I also find that it is more challenging to design meaningful interactive graphs that reveal insights without being distracting to the viewers. 
